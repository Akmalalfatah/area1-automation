...
function PreventiveRoutinePage({ data, file, date, busy, loading, filters, onFile, onDate, onUpload, onFilter, kind }) {
  ...
  const filtersBar = h("div", { className: "preventive-filter-row" }, h("div", null, h("label", { className: "filter-label mb-1 block" }, "SCHEDULE FROM"), h("input", { type: "date", value: filters.dateFrom, onChange: (e) => onFilter("dateFrom", e.target.value), className: "control h-10 w-[155px] px-3 text-[10px] font-semibold" })), h("div", null, h("label", { className: "filter-label mb-1 block" }, "SCHEDULE TO"), h("input", { type: "date", value: filters.dateTo, onChange: (e) => onFilter("dateTo", e.target.value), className: "control h-10 w-[155px] px-3 text-[10px] font-semibold" })), routineSelect("NOP", "nop", data && data.nop_options || [], "All NOP", "w-[170px]"), routineSelect("STATUS PM", "status", data && data.status_options || [], "All Status", "w-[150px]"), routineSelect("PIC", "pic", data && data.pic_options || [], "All PIC", "w-[170px]"), kind === "genset" ? h("div", { className: "contents" }, routineSelect("TYPE POWER", "typePower", data && data.type_power_options || [], "All Type Power", "w-[180px]"), routineSelect("SCOPE ITEM", "scopeItem", data && data.scope_item_options || [], "All Scope Item", "w-[210px]")) : h("div", { className: "contents" }, routineSelect("INTERVAL", "interval", data && data.interval_options || [], "All Interval", "w-[130px]"), routineSelect("KETERLAMBATAN", "scheduleState", ["overdue", "upcoming", "submitted"], "All Schedule", "w-[170px]")));
