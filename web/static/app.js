...
function PreventiveRoutinePage({ data, file, date, busy, loading, filters, onFile, onDate, onUpload, onFilter, kind }) {
  ...
  const filtersBar = h("div", { className: "preventive-filter-row" }, h("div", null, h("label", { className: "filter-label mb-1 block" }, "DATE FROM"), h("input", { type: "date", value: filters.dateFrom, onChange: (e) => onFilter("dateFrom", e.target.value), className: "control h-10 w-[155px] px-3 text-[10px] font-semibold" })), h("div", null, h("label", { className: "filter-label mb-1 block" }, "DATE TO"), h("input", { type: "date", value: filters.dateTo, onChange: (e) => onFilter("dateTo", e.target.value), className: "control h-10 w-[155px] px-3 text-[10px] font-semibold" })), h("div", null, h("label", { className: "filter-label mb-1 block" }, "NOP"), h("select", { value: filters.nop, onChange: (e) => onFilter("nop", e.target.value), className: "control h-10 w-[180px] px-3 text-[10px] font-semibold" }, h("option", { value: "" }, "All NOP"), ...((data && data.nop_options || []).map((item) => h("option", { key: item, value: item }, compactNop(item))))), h("div", null, h("label", { className: "filter-label mb-1 block" }, "SITE ID"), h("select", { value: filters.siteId, onChange: (e) => onFilter("siteId", e.target.value), className: "control h-10 w-[170px] px-3 text-[10px] font-semibold" }, h("option", { value: "" }, "All Site ID"), ...((data && data.site_options || []).map((item) => h("option", { key: item, value: item }, item))))), h("div", { className: "preventive-filter-search" }, h("label", { className: "filter-label mb-1 block text-right" }, "SEARCH"), h("input", { type: "search", value: filters.search, onChange: (e) => onFilter("search", e.target.value), placeholder: "Cari Site ID, Site Name, NOP, atau Notes", className: "control h-10 w-full px-3 text-[10px]" }))));
